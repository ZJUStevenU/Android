...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        Log.d("CodeLocation","Here!5");
        final Call<UploadResponse> repos = api.submitMessage(Constants.STUDENT_ID, "",
                fromPart, toPart, contentPart, Part_image, Constants.token);
        Log.d("CodeLocation","Here!3");
